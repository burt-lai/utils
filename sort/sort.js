 ...
 * @Last Modified time: 2022-09-11 12:21:55
 */
...
const arr = [1, 2, 3, 4]
console.log('before swap:', arr); // before swap: [ 1, 2, 3, 4 ]
swap(arr, 0, 1) // 执行交换，验证成功！
console.log('after swap:', arr); // after swap: [ 2, 1, 3, 4 ]
